...
- [ ] Add "Call Queue" to sidebar navigation with phone icon
- [ ] Add "Review Queue" to sidebar navigation with clipboard icon
- [ ] Add signal count badges to navigation (red dot for hot leads)
- [ ] Add keyboard shortcut hints in navigation items
- [ ] Ensure active page highlighting works on all routes
...
- [ ] Create `client/src/pages/add-lead.tsx` - manual lead entry form
- [ ] Add form fields for all lead properties (name, email, company, title, phone)
- [ ] Add company auto-complete from existing leads
- [ ] Add ICP auto-assignment based on company/title
- [ ] Add "Enrich on Save" toggle to auto-fetch company data
- [ ] Create `POST /api/leads` endpoint for manual creation
...
- [ ] Add "Quick Add Lead" button to global header
- [ ] Add keyboard shortcut (Cmd+N) for quick add modal
- [ ] Create minimal quick-add modal (name, email, company only)
- [ ] Auto-navigate to lead detail after creation
...
**Tasks Completed:** 48 / 207
**Current Phase:** Phase 8.1 Navigation (CRITICAL PATH)
